package net.sat.onlineshopping.handler;
...
import net.sat.onlineshopping.model.CheckoutModel;
import net.sat.onlineshopping.model.UserModel;
import net.sat.shoppingbackend.dao.CartLineDAO;
import net.sat.shoppingbackend.dao.ProductDAO;
import net.sat.shoppingbackend.dao.UserDAO;
import net.sat.shoppingbackend.dto.Address;
import net.sat.shoppingbackend.dto.Cart;
import net.sat.shoppingbackend.dto.CartLine;
import net.sat.shoppingbackend.dto.OrderDetail;
import net.sat.shoppingbackend.dto.OrderItem;
import net.sat.shoppingbackend.dto.Product;
import net.sat.shoppingbackend.dto.User;
